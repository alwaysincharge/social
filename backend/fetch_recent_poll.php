...
if(isset($_POST['fetchold']))  {
    ...
    $is_there = $posts->is_there_a_poll_in_this_group($_POST['group']);
    ...
    if ( $is_there_num == 0 ) {
      ...
      if ($_POST['offset'] == 0) {
          ...
          $old_posts = $posts->get_first_few_polls($_POST['group']);
          ...
          $old_posts = $posts->get_next_few_polls($_POST['offset'], $_POST['group']);
