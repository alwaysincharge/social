...
if(isset($_POST['poll']))  {
  ...
  if ( (strlen(trim($_POST['poll_a9'])) == 0) && (strlen(trim($_POST['poll_a10'])) > 0) ) {
    ...
    $posts->create_poll($_SESSION['admin_id'], $_POST['group_id'], $_POST['time'], strip_tags($_POST['poll_q']), strip_tags($_POST['poll_a1']), strip_tags($_POST['poll_a2']), strip_tags($_POST['poll_a3']), strip_tags($_POST['poll_a4']), strip_tags($_POST['poll_a5']), strip_tags($_POST['poll_a6']), strip_tags($_POST['poll_a7']), strip_tags($_POST['poll_a8']), strip_tags($_POST['poll_a9']), strip_tags($_POST['poll_a10']), $_POST['important']);
