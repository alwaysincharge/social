...
if(isset($_POST['fetchold']))  {
    ...
    $is_there = $posts->is_there_important_in_this_group();
    ...
    if ( $is_there_num == 0 ) {
      ...
      if ($_POST['offset'] == 0) {
          ...
          $old_posts = $posts->get_first_important_posts();
         ...
         $old_posts = $posts->get_next_important_posts($_POST['offset']);
