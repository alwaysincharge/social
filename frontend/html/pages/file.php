   ...
   <nav class="nav-head">
    ...
    <div class="row nav-main-row div-scale">
        ...
        <div class="col-xs-4">
            ...
            <a style="font-size: 16px;" href="<?php  echo $_SESSION['url_placeholder'];  ?>nogroups" class="logo-heading-1">friday camp <span class="logo-heading-2">//</span> files <span class="logo-heading-2">//</span> <span class="logo-heading-3">
                <?php
        ...
        <div class="col-xs-8">
            ...
            <input id="myTextBox"  maxlength="100" name="keywords" class="search-main" placeholder="Search group files" />
...
<div id="postsdiv" style="margin-top: 10px;">
     ...
     <div style="display: table; margin: 0 auto;">
                        ...
                        <p id="nopoll" style=" display: none; margin-bottom: 30px; font-size: 17px; font-family: Eczar;">No files here yet.</p> 
                ...
                <div class="col-xs-3 group-list-div">
                       ...
                       <p style="font-family: Work Sans; font-size: 20px; margin-left: 20px;">Files.</p>
                    
                    
                    
                    <p style="font-family: Work Sans; font-size: 17px; margin-left: 20px;">This is a list of files from the above named group.</p>
...
$("#myTextBox").on("input", function() {
    ...
    function search_posts(term) {
        ...
        search_posts_url = "<?php echo $_SESSION['url_placeholder'];  ?>search_files";
             ...
             for ( var search_i = 0; search_i < jsonSearchLength; search_i++ ) {
                ...
                // If the row's id is even.
                 ...
                 if(resultSearch.type == 'attach' && resultSearch.owner == "<?php echo $user_info['id']; ?>") {
                       ...
                       if ( (resultSearch.file_type == 'image/jpeg') || (resultSearch.file_type == 'image/jpg') ||  (resultSearch.file_type == 'image/png') || (resultSearch.file_type == 'image/gif')  ) {
                         
                         
                         htmlSearch += '<div id=\"'+ 'search_post' + resultSearch.id +'\" class=\"row\"   style=\"background: white; border-radius: 3px; margin-bottom: 30px;\"  data-toggle=\"tooltip\" data-placement=\"left\" title=\"'+ resultSearch.name +'\">';
                    
                         htmlSearch += '<div style=\"padding: 12px;\"><a class=\"text-username\"> ' + resultSearch.username + '</a><a class=\"text-body\" href=\" ' + resultSearch.path  + ' \" download>' + ' | Download' + '</a></div>';
                    
                         htmlSearch += '<img style=\"width: 100%;\" src=\"'+ resultSearch.path +'\" />';
                    
        
                    /*
                         htmlSearch += '<span style=\"display: table; margin: 0 auto; width: 300px; margin-top: 10px;\" id=\"' + new_post_id + '\" ></span>'; */
                         ...
                         htmlSearch += '<span style=\"display: table; margin: 0 auto; width: 300px; margin-top: 10px;\"><div class=\"row\" >';
...
function displayFromDatabasePagination() {
    ...
    fetch_old_url = "<?php echo $_SESSION['url_placeholder'];  ?>fetch_recent_files";
