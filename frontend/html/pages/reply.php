...
<div id="postsdiv" style="margin-top: 0px;">
                ...
                <div class="col-xs-3 group-list-div">
                    ...
                    <p style="font-family: Work Sans; font-size: 20px; margin-left: 20px;">Replies.</p>
                    
                    
                    
                    <p style="font-family: Work Sans; font-size: 17px; margin-left: 20px;">Replies on your messages from all your groups.</p>
          ...
          success: function( data ) {
            ...
            resultOldPost.groupname =  resultOldPost.groupname;
                  ...
                  how_many_tasks(resultOldPost.id);
                    ...
                    oldPostHtml += '<a href=\"'+ '<?php  echo $_SESSION['url_placeholder'];  ?>dashboard/'  +  resultOldPost.group_id  +'\" style=\"font-family: Work Sans; margin-left: 20px;\">// ' + resultOldPost.groupname + '</a>';
