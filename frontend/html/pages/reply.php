...
<?php $session->if_not_logged_in($_SESSION['url_placeholder'] . 'login'); $posts->delete_reply(); ?>
...
function displayFromDatabasePagination() {
    ...
    fetch_old_url = "<?php echo $_SESSION['url_placeholder'];  ?>fetch_reply_posts";
    ...
    flag =   $.ajax( {
            ...
            if (flag.readyState == 4 && flag.status == 200) { 
               ...
               for ( var for_oldpost = 0; for_oldpost < jsonOldLength; for_oldpost++ ) {
                  ...
                  how_many_tasks(resultOldPost.id);
                    ...
                    oldPostHtml += '<a href=\"'+ '<?php  echo $_SESSION['url_placeholder'];  ?>dashboard/'  +  resultOldPost.groupid  +'\" style=\"font-family: Work Sans; margin-left: 20px;\">// ' + resultOldPost.groupname + '</a>';
                    
                    oldPostHtml += '<p class=\"old-todo-para\">'+ resultOldPost.listname +'</p>';
                    
                    oldPostHtml += '<a><div class=\"old-todo-links\"> <a>'+ resultOldPost.username +' |</a> <a class=\"old-num-task-'+ resultOldPost.id +'\"></a> <a href=\"'+ '<?php echo $_SESSION['url_placeholder']; ?>list/' + page_group_id + '/' + resultOldPost.id +'">View To-do list</a> </div></a>';
        ...
        oldPostHtml += '<div class=\"col-xs-10 poll-body\">';
                      ...
                      oldPostHtml += '<p class=\"text-username\">' + resultOldPost.username + '  <a href=\"'+ '<?php  echo $_SESSION['url_placeholder'];  ?>dashboard/'  +  resultOldPost.groupid  +'\" style=\"font-family: Work Sans;\">// ' + resultOldPost.groupname + '</a></p>';
          ...
          oldPostHtml += '<div class=\"col-xs-2\"><img src=\" '+ '<?php echo $_SESSION['url_placeholder'];  ?>' + resultOldPost.image +'  \" style=\"width: 50px;  border-radius: 3px;\"  /></div></div>';
            ...
            window["votebuttonold" + resultOldPost.id] = true;
             ...
             getOldPollVote(resultOldPost.id);
                ...
                oldPostHtml += '<div class=\"talk-bubble tri-right left-top\" class=\"chat-left-2\">';
                oldPostHtml += '<div class=\"talktext\">';
                      oldPostHtml += '<a href=\"'+ '<?php  echo $_SESSION['url_placeholder'];  ?>dashboard/'  +  resultOldPost.groupid  +'\" style=\"font-family: Work Sans;\">// ' + resultOldPost.groupname + '</a>';
